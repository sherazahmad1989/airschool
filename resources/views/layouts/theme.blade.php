...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="{{ asset('theme/css/metisMenu.min.css') }}" rel="stylesheet">

    <!-- Custom CSS -->
    <!-- Custom CSS -->
    <link href="{{ asset('theme/css/startmin.css') }}" rel="stylesheet">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li class="sidebar-search" style="padding: 5px;">
                    </li>
                    <li>
...
<script src="{{ asset('theme/js/startmin.js') }}"></script>
